...
(function ($, Modernizr, image_editor)
{
    ...
    var FileManager = {
        ...
        contextActions: {
            ...
            unzip: function ($trigger)
            {
                ...
                $.ajax({
                    type: "POST",
                    url: "ajax_calls.php?action=extract&akey="+jQuery('#key_identifier').val(),
                    data: {
                        path: m
                    }
                }).done(function (msg)
            ...
            jQuery('#filter-input').on('keyup', function ()
            {
                ...
                if (js_script)
                {
                    delay(function ()
                    {
                        ...
                        $.ajax({
                            url: "ajax_calls.php?action=filter&type=" + val + "&akey=" + jQuery('#key_identifier').val()
                        }).done(function (msg)
                        {
                            if (msg != "")
                            {
        ...
        makeUploader: function ()
        {
            jQuery('#fileupload').fileupload({
                ...
                url: 'upload.php?akey=' + jQuery('#key_identifier').val(),
        ...
        makeSort: function (js_script)
        {
            ...
            jQuery('.sorter').on('click', function ()
            {
                ...
                {
                    $.ajax({
                        url: "ajax_calls.php?action=sort&sort_by=" + _this.attr('data-sort') + "&descending=" + (sortDescending ? 1 : 0) + "&akey=" + jQuery('#key_identifier').val()
                    });
    ...
    jQuery(document).ready(function ()
    {
        ...
        jQuery('.new-folder').on('click', function ()
        {
            bootbox.prompt(jQuery('#insert_folder_name').val(), jQuery('#cancel').val(), jQuery('#ok').val(), function (name)
            {
                if (name !== null)
                {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "execute.php?action=create_folder&akey=" + jQuery('#key_identifier').val(),
                        data: {
                            path: folder_path,
                            name: name
                        }
        ...
        jQuery('.view-controller button').on('click', function ()
        {
            ...
            $.ajax({
                url: "ajax_calls.php?action=view&type=" + _this.attr('data-value') + "&akey=" + jQuery('#key_identifier').val()
            }).done(function (msg)
            {
                if (msg != "")
                {
    ...
    function create_text_file()
    {
        ...
        $.ajax({
            type: "GET",
            url: "ajax_calls.php?action=new_file_form&akey=" + jQuery('#key_identifier').val()
                        ...
                        },
                        {
                            ...
                            "callback": function ()
                            {
                                ...
                                if (newFileName !== null)
                                {
                                    ...
                                    $.ajax({
                                        type: "POST",
                                        url: "execute.php?action=create_file&akey=" + jQuery('#key_identifier').val(),
                                        data: {
                                            path: folder_path,
                                            name: newFileName,
    ...
    function edit_text_file($trigger)
    {
        ...
        $.ajax({
            type: "POST",
            url: "ajax_calls.php?action=get_file&sub_action=edit&preview_mode=text&akey=" + jQuery('#key_identifier').val(),
            data: {path: full_path}
                    ...
                    [
                        ...
                        },
                        {
                            ...
                            "callback": function ()
                            {
                                ...
                                $.ajax({
                                    type: "POST",
                                    url: "execute.php?action=save_text_file&akey=" + jQuery('#key_identifier').val(),
                                    data: {
                                        path: full_path,
                                        new_content: newContent
                                    }
    ...
    function change_lang()
    {
        $.ajax({
            type: "POST",
            url: "ajax_calls.php?action=get_lang&akey=" + jQuery('#key_identifier').val(),
            data: {}
                    ...
                    [
                        ...
                        },
                        {
                            ...
                            "callback": function ()
                            {
                                ...
                                $.ajax({
                                    type: "POST",
                                    url: "ajax_calls.php?action=change_lang&akey=" + jQuery('#key_identifier').val(),
    ...
    function chmod($trigger)
    {
        ...
        $.ajax({
            type: "POST",
            url: "ajax_calls.php?action=chmod&akey=" + jQuery('#key_identifier').val(),
            data: {
                path: full_path,
                        ...
                        },
                        {
                            ...
                            "callback": function ()
                            {
                                ...
                                if (newPerm != '' && typeof newPerm !== "undefined")
                                {
                                    ...
                                    $.ajax({
                                        type: "POST",
                                        url: "execute.php?action=chmod&akey=" + jQuery('#key_identifier').val(),
                                        data: {
                                            path: full_path,
                                            new_mode: newPerm,
                                            is_recursive: recOpt,
    ...
    function clear_clipboard()
    {
        bootbox.confirm(jQuery('#lang_clear_clipboard_confirm').val(), jQuery('#cancel').val(), jQuery('#ok').val(), function (result)
        {
            if (result == true)
            {
                $.ajax({
                    type: "POST",
                    url: "ajax_calls.php?action=clear_clipboard&akey="  + jQuery('#key_identifier').val(),
                    data: {}
                }).done(function (msg)
                {
                    if (msg != "")
    ...
    function copy_cut_clicked($trigger, atype)
    {
        ...
        $.ajax({
            type: "POST",
            url: "ajax_calls.php?action=copy_cut&akey=" + jQuery('#key_identifier').val(),
            data: {
                path: full_path,
                sub_action: atype
            }
    ...
    function paste_to_this_dir(dnd)
    {
        bootbox.confirm(jQuery('#lang_paste_confirm').val(), jQuery('#cancel').val(), jQuery('#ok').val(), function (result)
        {
            if (result == true)
            {
                ...
                $.ajax({
                    type: "POST",
                    url: "execute.php?action=paste_clipboard&akey=" + jQuery('#key_identifier').val(),
                    data: {
                        path: folder_path
                    }
                }).done(function (msg)
...
// because of feedback and on error bahhhhh...
    ...
    function execute_action(action, file, name, container, function_name)
    {
        if (name !== null)
        {
            ...
            $.ajax({
                type: "POST",
                url: "execute.php?action=" + action + "&akey=" + jQuery('#key_identifier').val(),
                data: {
                    path: file,
                    name: name.replace('/', '')
                }
